...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"صفحه اول",sLast:"صفحه آخر",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"داده ای برای نمایش وجود ندارد",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ ردیف",sInfoEmpty:"نمایش 0 تا 0 از 0 ردیف",
sInfoFiltered: "(فیلتر شده از _MAX_ ردیف)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "نمایش _MENU_ ردیف", sLoadingRecords: "در حال بارگذاری...", sProcessing: "در حال پردازش...", sSearch: "جستجو : ", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "رکوردی یافت نشد"}, oSearch: h.extend({}, l.models.oSearch), sAjaxDataProp: "data", sAjaxSource: null, sDom: "lfrtip", searchDelay: null, sPaginationType: "simple_numbers", sScrollX: "", sScrollXInner: "", sScrollY: "", sServerMethod: "GET", renderer: null, rowId: "DT_RowId"};
